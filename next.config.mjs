...
const securityHeaders = [
  ...
  // Content Security Policy - Ajustado para Stripe, GTM, Google Ads y Vercel
  {
    ...
    value: [
      ...
      // Frames: Stripe, GTM (para tags), hCaptcha
      "frame-src https://js.stripe.com https://hooks.stripe.com https://www.googletagmanager.com https://newassets.hcaptcha.com https://www.google.com",
